...
public class DungeonMasterTest extends TestCase {
	...
	/**
	 * Test de d�placement d'un groupe dans le donjon.
	 */
	...
	/**
	 * Un mur doit emp�cher le groupe de se d�placer.
	 */
	...
	public void testChampionsHurtWhenHittingConcreteWalls() {
		...
		// --- FORWARD. Seuls deux h�ros sont bless�s
		...
		// --- LEFT. Seuls deux h�ros sont bless�s
	...
	// FIXME Impl�menter le nombre de charges par item + utilisation limit�e
}
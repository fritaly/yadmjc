...
public final class WallSwitch extends DirectedElement implements HasActuator, Triggerable {
	...
	/**
	 * Indique si le bouton est enfonc� ou pas. Par d�faut il ne l'est pas. N'a
	...
	/**
	 * Indique si le bouton est de type poussoir. Vaut true par d�faut.
	 */
	...
	public void toggle() {
		if (isPushButton()) {
			// Le bouton poussoir change d'�tat
			this.pressed = !pressed;

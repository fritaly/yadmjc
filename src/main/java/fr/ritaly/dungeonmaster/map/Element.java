...
public abstract class Element implements ChangeEventSource, HasPosition {
	...
	// FIXME Prot�ger l'appel � cette m�thode par un aspect
	// Cette m�thode ne doit �tre appel�e que depuis la classe Level. On ne peut
	// cependant la d�clarer package protected car on en a besoin dans l'algo A*
	// de recherche de chemin lorsque l'on cr�e un faux �l�ment de test afin de
	// d�terminer si le chemin en cours d'�valuation est meilleur que l'actuel

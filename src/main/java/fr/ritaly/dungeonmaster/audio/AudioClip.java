...
public enum AudioClip {
	/**
	 * Son des pas quand le groupe se d�place
	 */
	STEP("step.wav"),

	/**
	 * Son quand une porte est d�truite
	 */
	...
	/**
	 * Son quand on frappe sur une porte mais qu'elle ne c�de pas
	 */
	CLONK("thunk.wav"),

	/**
	 * Son d'un coup port� dans le vide
	 */
	SWING("swing.wav"),
